...
})({"kOtn0":[function(require,module,exports) {
...
},{"react-refresh/runtime":"es9k2","react-error-overlay":"b4Hmd"}],"es9k2":[function(require,module,exports) {
"use strict";
module.exports = require("./cjs/react-refresh-runtime.development.js");

},{"./cjs/react-refresh-runtime.development.js":"5Rpsj"}],"5Rpsj":[function(require,module,exports) {
...
},{}],"b4Hmd":[function(require,module,exports) {
...
},{"process":"iIoJh"}],"iIoJh":[function(require,module,exports) {
...
},{}],"eqbdz":[function(require,module,exports) {
"use strict";
...
const myAlgoConnect = new (0, _myalgoConnectDefault.default)({
...
},{"@randlabs/myalgo-connect":"gAgoh","@parcel/transformer-js/src/esmodule-helpers.js":"akdWl"}],"gAgoh":[function(require,module,exports) {
module.exports = require("./lib/main");

},{"./lib/main":"4rFGr"}],"4rFGr":[function(require,module,exports) {
 ...
 */ class MyAlgoConnect {
	 ...
	 */ constructor(options){
        if (!bridge) bridge = new Messaging();
        /**
		 * @access private
		 * @type {Messaging}
		 */ this.bridge = bridge;
	 ...
	 */ async connect(settings = {
        ...
        if (this.currentConnectPopup) {
            if (this.currentConnectPopup.closed) this.currentConnectPopup = null;
            else this.focusWindow(this.currentConnectPopup);
        }
        try {
	 ...
	 */ async signTransaction(transaction, signOptions) {
        ...
        if (this.currentSigntxPopup) {
            if (this.currentSigntxPopup.closed) this.currentSigntxPopup = null;
            else this.focusWindow(this.currentSigntxPopup);
        }
	 ...
	 */ async signLogicSig(logic, address) {
        if (this.currentSignLogicSigPopup) {
            if (this.currentSignLogicSigPopup.closed) this.currentSignLogicSigPopup = null;
            else this.focusWindow(this.currentSignLogicSigPopup);
        }
        try {
	 ...
	 */ async tealSign(data, contractAddress, address) {
        if (this.currentTealSignPopup) {
            if (this.currentTealSignPopup.closed) this.currentTealSignPopup = null;
            else this.focusWindow(this.currentTealSignPopup);
        }
        try {
	 ...
	 * @returns {void}
	 */ closeWindow(window) {
        if (window && !window.closed && window.close) window.close();
    }
    /**
	 * @access private
	 ...
	 */ focusWindow(window) {
        ...
        } else throw new Error(Errors.INVALID_WINDOW);
    }
}
module.exports = MyAlgoConnect;

},{"buffer":"fdQwY","./popup/popup":"2umd7","./utils/utils":"djEcv","./utils/errors":"04kzE","./messaging/Messaging":"dAvZI"}],"fdQwY":[function(require,module,exports) {
/*!
...
},{"base64-js":"4ZBSf","ieee754":"bfNNo"}],"4ZBSf":[function(require,module,exports) {
"use strict";
...
},{}],"bfNNo":[function(require,module,exports) {
...
},{}],"2umd7":[function(require,module,exports) {
 ...
 */ function openPopup(url, options = defaultOptions) {
    ...
    if (width) {
        if (window.outerWidth) left = Math.round((window.outerWidth - width) / 2) + window.screenX;
        else if (window.screen.width) left = Math.round((window.screen.width - width) / 2);
    }
    if (height) {
        if (window.outerHeight) top = Math.round((window.outerHeight - height) / 2) + window.screenY;
        else if (window.screen.height) top = Math.round((window.screen.height - height) / 2);
    }
    ...
    const params = Object.keys(options).map((key)=>{
        ...
        if (param !== null && param !== undefined && typeof param.toString === "function") return `${key}=${param.toString()}`;
    }).filter(Boolean).join(",");
    let win;
    try {
    ...
    if (!win || window.closed) throw new Error(`${WINDOW_NOT_OPENED} - blocked`);
    return win;
}
module.exports = {
    openPopup
...
},{"../utils/errors":"04kzE"}],"04kzE":[function(require,module,exports) {
module.exports = {
...
},{}],"djEcv":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
...
},{"buffer":"fdQwY"}],"dAvZI":[function(require,module,exports) {
...
},{"@randlabs/communication-bridge":"fjvqo"}],"fjvqo":[function(require,module,exports) {
module.exports = require("./lib/messenger");

},{"./lib/messenger":"5AczK"}],"5AczK":[function(require,module,exports) {
class Messenger {
    /**
	 * @callback onMessage
	 * @param {error} err
...
},{}],"akdWl":[function(require,module,exports) {
...
},{}]},["kOtn0","eqbdz","2kQhy"], "2kQhy", "parcelRequiree280")
